...
<!--      </el-checkbox>-->
    ...
    >
      ...
      <el-table-column :label="$t('table.location')" width="110px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.author }}</span>
        </template>
      </el-table-column>

      <el-table-column :label="$t('table.money')" width="110px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.author }}</span>
        </template>
      </el-table-column>
...
<!--          </el-button>-->
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="60%">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="80px" style="width: 650px; margin-left:50px;">
        <el-form-item :label="$t('table.applyAssociation')" >
          <el-input v-model="temp.title" :disabled="true"/>
        </el-form-item>
        <!--        <el-form-item :label="$t('table.date')" prop="timestamp">-->
        <!--          <el-date-picker v-model="temp.timestamp" type="datetime" placeholder="Please pick a date" />-->
        <!--        </el-form-item>-->
        <el-form-item :label="$t('table.date')" style="width: 300px" >
          <el-input v-model="temp.title":disabled="true" />
        </el-form-item>
        ...
        <!--        </el-form-item>-->
        <el-form-item :label="$t('table.explain')">
          <el-input v-model="temp.remark"  :rows="6" type="textarea"  />
        </el-form-item>
      </el-form>
...
<script>
import { selectAction } from '@/api/Action'
import waves from '@/directive/waves' // waves directive
import { parseTime } from '@/utils'
import Pagination from '@/components/Pagination'
import {updateStatus} from "@/api/Action"; // secondary package based on el-pagination
...
export default {
  ...
  methods: {
    getList(){
      ...
      selectAction(this.listQuery).then(response => {
