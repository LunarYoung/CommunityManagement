...
<!--&lt;!&ndash;        <el-button v-loading="loading" type="warning" @click="draftForm">&ndash;&gt;-->
<!--&lt;!&ndash;          Draft&ndash;&gt;-->
...
<!--          <Warning />-->
          ...
          <el-col :span="20">
            ...
            <div class="postInfo-container">
              <el-row>
                <el-col :span="8">
                  <el-form-item label-width="80px" label="社团所属:" class="postInfo-container-item">
                    <el-select v-model="postForm.ass" :placeholder="$t('table.associationType')" clearable class="filter-item" style="width: 200px">
                ...
                <el-col :span="8">
                  <el-form-item label-width="80px" label="类型:" class="postInfo-container-item">
                    <el-select v-model="postForm.type" placeholder="请选择文章类型">
                ...
                <el-col :span="8">
                <el-button v-loading="loading" style="margin-left: 100px;" type="success" @click="submitForm">
                  发布
                </el-button>
                </el-col>
<!--                <el-col :span="10">-->
...
import {add, Base} from '@/api/article'
