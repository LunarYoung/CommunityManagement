<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.title" :placeholder="$t('table.reviewer')" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
...
<!--      </el-checkbox>-->
    ...
    >
      ...
      <el-table-column :label="$t('table.applyAssociation')" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" @click="handleUpdate(row)">{{ row.title }}</span>
<!--          <el-tag>{{ row.type | typeFilter }}</el-tag>-->
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.examine')" width="110px" align="center">
        <template slot-scope="{row}">
...
<!--        </el-form-item>-->
        ...
        <!--        </el-form-item>-->
        <el-form-item :label="$t('table.thing')" style="width: 300px">
          <el-input v-model="temp.title" :disabled="true"/>
        </el-form-item>
        <el-form-item :label="$t('association.suming')" style="width: 300px">
          <el-input v-model="temp.title" :disabled="true"/>
        </el-form-item>
        <el-form-item :label="$t('table.location')" style="width: 300px">
          <el-input v-model="temp.title" :disabled="true"/>
        </el-form-item>
        <el-form-item :label="$t('table.money')" style="width: 300px">
          <el-input v-model="temp.title" :disabled="true"/>
        </el-form-item>
...
<!--        </el-form-item>-->
        ...
        <el-form-item :label="$t('table.explain')">
          <el-input v-model="temp.remark"  :rows="6" type="textarea" :disabled="true" />
        </el-form-item>
      </el-form>
